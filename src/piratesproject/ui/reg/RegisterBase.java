...
public class RegisterBase extends AnchorPane {
    ...
    private void draw() {
        ...
        imageView.setImage(new Image(getClass().getResource("/piratesproject/drawable/images/registerBg.jpg").toExternalForm()));
      ...
      //  if (!stage.isMaximized()) {
            ...
            firstNameTF.setStyle("-fx-background-radius: 100;");
            ...
            lastNameTF.setStyle("-fx-background-radius: 100;");
            ...
            usernameTF.setStyle("-fx-background-radius: 100px;");
            ...
            passwordTF.setStyle("-fx-background-radius: 100;");
