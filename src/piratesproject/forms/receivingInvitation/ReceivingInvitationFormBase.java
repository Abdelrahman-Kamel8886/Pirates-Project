...
public abstract class ReceivingInvitationFormBase extends VBox {
    ...
    public ReceivingInvitationFormBase() {
        ...
        setPrefHeight(400.0);
        setPrefWidth(600.0);
         getStylesheets().add(Pathes.RECEIVINGINVITIONFORM_STYLE_PATH);
        ...
        VBox.setMargin(label, new Insets(15.0, 0.0, 0.0, 85.0));
        ...
        imageView.setImage(new Image(getClass().getResource(Pathes.AVATAR_LOGO_PATH).toExternalForm()));
